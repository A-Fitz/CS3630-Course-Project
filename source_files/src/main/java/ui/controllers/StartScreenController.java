...
public class StartScreenController implements Initializable {
    ...
    public void addFlightButtonClicked(ActionEvent actionEvent) {
        changeScreen("/AddFlightScreen.fxml", "Add Flight");
    }

    public void editAirlineButtonClicked(ActionEvent actionEvent) {
        changeScreen("/EditAirlineScreen.fxml", "Edit Airline");
    }

    public void addJobTypeButtonClicked(ActionEvent actionEvent) {
        changeScreen("/AddJobTypeScreen.fxml", "Add Job Type");
    }

    public void addBaggageStatusTypeButtonClicked(ActionEvent actionEvent) {
        changeScreen("/AddBaggageStatusTypeScreen.fxml", "Add Baggage Status Type");
    }

    public void addFlightStatusTypeButtonClicked(ActionEvent actionEvent) {
        changeScreen("/AddFlightStatusTypeScreen.fxml", "Add Flight Status Type");
    }

    public void addAirlineEmployeeToFlightButtonClicked(ActionEvent actionEvent) {
        changeScreen("/AddAirlineEmployeeToFlightScreen.fxml", "Add Airline Employee To Flight");
    }

    public void addSeatClassTypeButtonClicked(ActionEvent actionEvent) {
        changeScreen("/AddSeatClassTypeScreen.fxml", "Add Seat Class Type");
    }

    public void addTicketStatusTypeButtonClicked(ActionEvent actionEvent) {
        changeScreen("/AddTicketStatusTypeScreen.fxml", "Add Ticket Status Type");
    }

    public void deleteBaggageButtonClicked(ActionEvent actionEvent) {
        changeScreen("/DeleteBaggageScreen.fxml", "Delete Baggage");
    }
